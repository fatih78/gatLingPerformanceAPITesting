@karate
Feature: Testing7 valid GET endpoint
  ...
  Scenario: Testing valid GET endpoint - SEVEN
    Given path 'drinks'
    When method get
    Then status 200
    And print 'Response is: ', response

  Scenario: validating first set of data contains all the values for 'Raki' - SEVEN
  ...
  Scenario: validating second set of data contains all the values for 'Cola' - SEVEN
  ...
  Scenario: validating third set of data contains all the values for 'Gazoz' - SEVEN
