@karate
Feature: Testing6 valid GET endpoint
  ...
  Scenario: Testing valid GET endpoint - SIX
    Given path 'drinks'
    When method get
    Then status 200
    And print 'Response is: ', response

  Scenario: validating first set of data contains all the values for 'Raki' - SIX
  ...
  Scenario: validating second set of data contains all the values for 'Cola' - SIX
  ...
  Scenario: validating third set of data contains all the values for 'Gazoz' - SIX
