@karate
Feature: Testing3 valid GET endpoint
  ...
  Scenario: Testing valid GET endpoint - THREE
    Given path 'drinks'
    When method get
    Then status 200
    And print 'Response is: ', response

  Scenario: validating first set of data contains all the values for 'Raki' - THREE
  ...
  Scenario: validating second set of data contains all the values for 'Cola' - THREE
  ...
  Scenario: validating third set of data contains all the values for 'Gazoz' - THREE
