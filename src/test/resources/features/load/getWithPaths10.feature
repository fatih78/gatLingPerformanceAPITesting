@karate
Feature: Testing10 valid GET endpoint
  ...
  Scenario: Testing valid GET endpoint - TEN
    Given path 'drinks'
    When method get
    Then status 200
    And print 'Response is: ', response

  Scenario: validating first set of data contains all the values for 'Raki' - TEN
  ...
  Scenario: validating second set of data contains all the values for 'Cola' - TEN
  ...
  Scenario: validating third set of data contains all the values for 'Gazoz' - TEN
