...
Feature: Testing valid GET endpoint
  ...
  Scenario: Testing valid GET endpoint - ONE
    Given path 'drinks'
    When method get
    Then status 200
    And print 'Response is: ', response

  Scenario: validating first set of data contains all the values for 'Raki' - ONE
  ...
  Scenario: validating second set of data contains all the values for 'Cola' - ONE
  ...
  Scenario: validating third set of data contains all the values for 'Gazoz' - ONE
