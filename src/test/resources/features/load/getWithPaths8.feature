@karate
Feature: Testing8 valid GET endpoint
  ...
  Scenario: Testing valid GET endpoint - EIGHT
    Given path 'drinks'
    When method get
    Then status 200
    And print 'Response is: ', response

  Scenario: validating first set of data contains all the values for 'Raki' - EIGHT
  ...
  Scenario: validating second set of data contains all the values for 'Cola' - EIGHT
  ...
  Scenario: validating third set of data contains all the values for 'Gazoz' - EIGHT
